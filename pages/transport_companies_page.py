...
class TransportCompaniesPage:
    ...
    def filter_transport_company(self, tkInfo):
        ...
        self.helper.fill_field_with_delay(
            self.FILTER_TK, tkInfo[TransportCompanies.SHORT_NAME_TRANSPORTER]
        )
        self.helper.wait_for_element_visible(
            '//span[text()="' + tkInfo[TransportCompanies.SHORT_NAME_TRANSPORTER] + '"]'
        ).click()
    ...
    def delete_first_transport_company_on_the_list(self, tkInfo):
        ...
        assert (
            tkInfo[TransportCompanies.SHORT_NAME_TRANSPORTER]
            in self.helper.wait_for_element_visible('[data-qa="typo-delete-tc"]').text
