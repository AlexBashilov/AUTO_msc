...
from api_pages.models.createDriver import CreateDriverErrorSchema, ErrorMessage, ErrorData
...
from test_data.api.test_params.create_driver import create_valid_drivers_parameters, create_drivers_required_parameters, \
...
class TestCreateDriver:
    ...
    def test_create_driver_with_same_passport(self, client, db_connection):
        ...
        expected_error_response = CreateDriverErrorSchema(
            errors=[ErrorMessage(
                data=ErrorData(
                    anotherDriverId=valid_response_model.result.id
                ),
