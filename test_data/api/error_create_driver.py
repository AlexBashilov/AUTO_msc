...
class CreateDriverError(enum.StrEnum):
    ...
    EMPTY_PASSPORT_NUMBER_ERROR = "Ошибка валидации запроса: поле PassportFullNumber должно быть не пустое"
    EMPTY_LICENSE_NUMBER_ERROR = "Ошибка создания водителя: Необходимо заполнить поле \"Водительское удостоверение\""
    PASSPORT_LENGTH_ERROR = "Ошибка валидации запроса: паспорт не должен включать больше 20 символов"
